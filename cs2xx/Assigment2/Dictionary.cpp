...
void Dictionary::ProcessTransactionFile()
{
	...
	while(fin >> command >> data)
	{
		if(command == "AddW")
		{
			...
			if(result == false)
				cout << "The word " << data << "Couldnt add" << endl;
			else
				cout << "The word " << data << "was added" << endl;
		}
		else if(command == "DeleteW")
		{
			...
			if(result == false)
				...
				cout << "The word " << data << "was deleted" << endl;
		}
		...
		else if(command == "SpellCheck")
		{
			...
			if(result == false)
				cout << "The file " << data << "could not be open" << endl;
			else
				cout << "\nThe file " << data << "Spell Checked" << endl;
		}
		else if(command == "InsertF")
		{
			result = InsertWordsIntoDict(data);
			if(result == false)
				cout << "The file " << data << "didnt open" << endl;
			else
				cout << "The file " << data << "inserted!" << endl;
		}
		else
		{
